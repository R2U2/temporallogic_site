...
#ifdef RTR2U2_LOW_LEVEL_OS
//NOTE1: these tasks seem to be interesting (sometimes overruns, or important etc)
...
//NOTE1	rtr2u2_task_data read_radio;
//	rtr2u2_task_data check_short_failsafe;
//NOTE1	rtr2u2_task_data ahrs_update;
//NOTE1	rtr2u2_task_data update_speed_height;
...
//NOTE1	rtr2u2_task_data gcs_retry_deferred;
//NOTE1 rtr2u2_task_data update_GPS;
//NOTE1 rtr2u2_task_data navigate;
...
//NOTE1	rtr2u2_task_data gcs_update;
	rtr2u2_task_data gcs_data_stream_send; //NOTE1
...
/*0*/  { NULL, NULL }, //read_radio
/*1*/  { NULL, NULL }, //check_short_failsafe
/*2*/  { NULL, NULL }, //ahrs_update
/*3*/  { NULL, NULL }, //update_speed_height
/*4*/  { NULL, NULL	}, //update_flight_mode
/*5*/  { NULL, NULL }, //stabilize
/*6*/  { NULL, NULL }, //set_servos
/*7*/  { NULL, NULL	}, //read_control_switch
/*8*/  { NULL, NULL	},  //gcs_retry_deferred
/*9*/  { NULL, NULL }, //update_GPS
/*10*/ { NULL, NULL }, //navigate
...
/*17*/ { NULL, NULL	}, //gcs_update
/*18*/ { &rtr2u2_at_buffer_current.gcs_data_stream_send, &rtr2u2_at_buffer_last.gcs_data_stream_send }, //gcs_data_stream_send
/*19*/ { &rtr2u2_at_buffer_current.update_mount, &rtr2u2_at_buffer_last.update_mount }, //update_mount
/*20*/ { &rtr2u2_at_buffer_current.update_events, &rtr2u2_at_buffer_last.update_events }, //update_events
/*21*/ { &rtr2u2_at_buffer_current.check_usb_mux, &rtr2u2_at_buffer_last.check_usb_mux }, //check_usb_mux
/*22*/ { &rtr2u2_at_buffer_current.read_battery, &rtr2u2_at_buffer_last.read_battery }, //read_battery
/*23*/ { &rtr2u2_at_buffer_current.compass_accumulate, &rtr2u2_at_buffer_last.compass_accumulate }, //compass_accumulate
/*24*/ { &rtr2u2_at_buffer_current.barometer_accumulate, &rtr2u2_at_buffer_last.barometer_accumulate }, //barometer_accumulate
